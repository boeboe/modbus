...
func (eh *exampleHandler) HandleCoils(ctx context.Context, req *modbus.CoilsRequest) (res []bool, err error) {
	if req.UnitId != 1 {
...
func (eh *exampleHandler) HandleDiscreteInputs(ctx context.Context, req *modbus.DiscreteInputsRequest) (res []bool, err error) {
...
func (eh *exampleHandler) HandleHoldingRegisters(ctx context.Context, req *modbus.HoldingRegistersRequest) (res []uint16, err error) {
	var regAddr uint16
...
func (eh *exampleHandler) HandleInputRegisters(ctx context.Context, req *modbus.InputRegistersRequest) (res []uint16, err error) {
	var unixTs_s uint32
